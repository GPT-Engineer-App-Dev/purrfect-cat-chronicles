    ...
    <div className="container mx-auto px-4 py-8 bg-gray-100">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="bg-white p-6 rounded-lg shadow-md border-2 border-gray-300">
          ...
          <Button onClick={nextFact} className="mb-4 bg-gray-500 hover:bg-gray-600 text-white">
            <Moon className="mr-2 h-4 w-4" /> Next Moonlit Fact
          </Button>
          ...
          <div className="flex items-center">
            ...
            <span className="ml-4 text-gray-600">{likes} cat lovers</span>
          </div>
        </div>
      </div>
    </div>
