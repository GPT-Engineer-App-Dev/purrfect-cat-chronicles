      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="bg-white p-6 rounded-lg shadow-md border-2 border-green-300">
          ...
          <div className="bg-green-100 p-4 rounded-lg mb-4">
            <p className="text-lg text-green-700">{catFacts[currentFact]}</p>
          </div>
          <Button onClick={nextFact} className="mb-4 bg-green-600 hover:bg-green-700 text-white">
          ...
          <div className="flex items-center">
            ...
            <span className="ml-4 text-green-600">{likes} cat lovers</span>
          </div>
        </div>
      </div>
    </div>
